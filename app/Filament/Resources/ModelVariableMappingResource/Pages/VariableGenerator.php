                    ...
                    Forms\Components\Wizard\Step::make('Tipo de Variable')
                        ->schema([
                            Forms\Components\Select::make('variable_type')
                                ...
                                ->required()
                                ->options([
                                    'simple_field' => '📊 Campo Simple - Mostrar un campo del modelo',
                                    'user_info' => '👤 Información de Usuario - Datos del creador/editor',
                                    'relationship' => '🔗 Relación - Datos de modelos relacionados',
                                    'formatted_date' => '📅 Fecha Formateada - Fechas en formato personalizado',
                                    'computed' => '🔢 Valor Computado - Cálculos o concatenaciones',
                                    'conditional' => '⚡ Valor Condicional - Diferentes valores según condiciones',
                                ])
                                ->reactive()
